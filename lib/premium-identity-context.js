/**
 * FORGE.pub – Master- vs. Fork-Erkennung für geteilten Code
 *
 * `bots/settings/**` ist dieselbe Datei auf dem Master und auf jedem FORGE.pub-Fork
...
/** true auf jedem FORGE.pub-Fork. Reine Bequemlichkeit, invers zu isMasterInstance(). */
