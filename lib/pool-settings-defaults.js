...
export const POOL_SETTINGS_DEFAULTS = {
    ...
    scoreLimit: {
        // false seit 2026-08-21 (vorher true, siehe Git-Historie): Score Limit ist jetzt
        // für neue Pools standardmäßig aus, muss bewusst in ForgeSettings aktiviert werden.
        enabled:       false,
        minScore:      30,
        swapToUsdc:    true,
        sendTo:        '',
